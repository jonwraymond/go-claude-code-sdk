...
func TestManager_GetAuthenticator(t *testing.T) {
	...
	err := manager.StoreAPIKey(ctx, apiKeyID, "sk-ant-api03-validtestkey1234567890abcdefghijklmnopqrstuvwxyz")
	if err != nil {
...
func TestManager_DeleteCredential(t *testing.T) {
	...
	id := "test-delete"
	err := manager.StoreAPIKey(ctx, id, "sk-ant-api03-validtestkey1234567890abcdefghijklmnopqrstuvwxyz")
	if err != nil {
...
func TestManager_ListCredentials(t *testing.T) {
	...
	creds := map[string]string{
		"api-1": "sk-ant-api03-testkey1234567890abcdefghijklmnopqrstuvwxyz",
		"api-2": "sk-ant-api03-testkey2345678901abcdefghijklmnopqrstuvwxyz",
		"api-3": "sk-ant-api03-testkey3456789012abcdefghijklmnopqrstuvwxyz",
	}
