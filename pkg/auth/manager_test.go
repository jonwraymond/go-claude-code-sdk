...
func TestManager_StoreAPIKey(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name:    "valid API key",
			id:      "test-api-key",
			apiKey:  "sk-ant-api03-validtest-key-123456789abcdefghijklmnopqrstuvwxyz",
			wantErr: false,
		},
		{
...
func TestManager_GetAuthenticator(t *testing.T) {
	...
	err := manager.StoreAPIKey(ctx, apiKeyID, "sk-ant-api03-validtest-key-123456789abcdefghijklmnopqrstuvwxyz")
	if err != nil {
...
func TestManager_DeleteCredential(t *testing.T) {
	...
	id := "test-delete"
	err := manager.StoreAPIKey(ctx, id, "sk-ant-api03-validtest-key-123456789abcdefghijklmnopqrstuvwxyz")
	if err != nil {
...
func TestManager_ListCredentials(t *testing.T) {
	...
	creds := map[string]string{
		"api-1": "sk-ant-api03-test1-key-123456789abcdefghijklmnopqrstuvwxyz",
		"api-2": "sk-ant-api03-test2-key-123456789abcdefghijklmnopqrstuvwxyz",
		"api-3": "sk-ant-api03-test3-key-123456789abcdefghijklmnopqrstuvwxyz",
	}
