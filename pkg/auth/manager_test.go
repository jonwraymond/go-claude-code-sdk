...
func TestManager_StoreAPIKey(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name:    "valid API key",
			id:      "test-api-key",
			apiKey:  "sk-ant-validkeyfortesting123456789",
			wantErr: false,
		},
		{
...
func TestManager_GetAuthenticator(t *testing.T) {
	...
	err := manager.StoreAPIKey(ctx, apiKeyID, "sk-ant-validkeyfortesting123456789")
	if err != nil {
...
func TestManager_DeleteCredential(t *testing.T) {
	...
	id := "test-delete"
	err := manager.StoreAPIKey(ctx, id, "sk-ant-validkeyfortesting123456789")
	if err != nil {
...
func TestManager_ListCredentials(t *testing.T) {
	...
	creds := map[string]string{
		"api-1": "sk-ant-api1keyfortesting1234567890123456",
		"api-2": "sk-ant-api2keyfortesting2345678901234567",
		"api-3": "sk-ant-api3keyfortesting3456789012345678",
	}
